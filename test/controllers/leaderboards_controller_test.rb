...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference('Leaderboard.count') do
      post leaderboards_url, params: { leaderboard: { Subgenre_id: @leaderboard.Subgenre_id, User_id: @leaderboard.User_id, score: @leaderboard.score } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { Subgenre_id: @leaderboard.Subgenre_id, User_id: @leaderboard.User_id, score: @leaderboard.score } }
