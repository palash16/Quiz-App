...
class SubgenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subgenre" do
    assert_difference('Subgenre.count') do
      post subgenres_url, params: { subgenre: { genre_id: @subgenre.genre_id, title: @subgenre.title } }
    end
  ...
  test "should update subgenre" do
    patch subgenre_url(@subgenre), params: { subgenre: { genre_id: @subgenre.genre_id, title: @subgenre.title } }
